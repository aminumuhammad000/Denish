...
const barData = [22, 30, 28, 14, 35, 28, 25];
...
const breakdown = [
  ...
  { day: 'Thursday',  orders: 14, amount: '₦41,000' },
  { day: 'Friday',    orders: 19, amount: '₦56,000' },
  { day: 'Saturday',  orders: 23, amount: '₦68,000' },
  { day: 'Sunday',    orders: 13, amount: '₦38,000' },
];
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceAmount}>₦248,500</Text>
        ...
        <View style={styles.statsRow}>
          {[
            { icon: 'pulse-outline', value: '₦289.0K', label: 'Weekly revenue' },
            { icon: 'calendar-outline', value: '97',      label: 'Orders' },
            { icon: 'tablet-portrait-outline', value: '₦2,979', label: 'Avg. orders' },
          ].map((s) => (
