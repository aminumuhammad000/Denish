    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.featuresContainer}>
          <FeatureCard
            icon={<Ionicons name="restaurant-outline" size={24} color="#FF8C00" />}
            title="Wide Variety"
            subtitle="Access thousands of local restaurants."
            iconContainerColor="#FFF5E6"
          />
          <FeatureCard
            icon={<Ionicons name="flashlight-outline" size={24} color="#FF8C00" />}
            title="Swift Delivery"
            subtitle="Real-time tracking for every order."
            iconContainerColor="#FFF5E6"
          />
          <FeatureCard
            icon={<Ionicons name="card-outline" size={24} color="#FF8C00" />}
