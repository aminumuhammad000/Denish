...
const styles = StyleSheet.create({
  ...
  onlineLeft: { flexDirection: 'row', alignItems: 'center', gap: 15 },
  powerIconContainer: {
    width: 48,
    height: 48,
    borderRadius: 24,
  ...
  onlineText: { fontSize: 17, fontWeight: 'bold', color: '#0F172A' },
  ...
  statusBadgeText: { color: '#3B82F6', fontSize: 11, fontWeight: '600' },
  deliveryPrice: { fontSize: 16, fontWeight: 'bold', color: '#059669' },
  addressSection: { flexDirection: 'row', gap: 15 },
  timelineContainer: { alignItems: 'center', width: 10 },
  timelineDot: { width: 8, height: 8, borderRadius: 4 },
  timelineLine: { flex: 1, width: 1, backgroundColor: '#F1F5F9', marginVertical: 4 },
  addressInfo: { flex: 1 },
  addressBlock: { gap: 2 },
  addressLabel: { fontSize: 9, fontWeight: '800', color: '#94A3B8', letterSpacing: 0.5 },
  ...
  orderId: { fontSize: 11, color: '#94A3B8' },
  continueLink: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  continueLinkText: { color: Colors.primary, fontSize: 15, fontWeight: '700' },
  newRequestCard: {
    backgroundColor: '#FFF',
    borderRadius: 20,
    borderWidth: 1,
  ...
  requestMain: { flexDirection: 'row', justifyContent: 'space-between', padding: 20 },
  requestLeft: { flex: 1, gap: 4 },
  requestStatusHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  requestDot: { width: 7, height: 7, borderRadius: 3.5, backgroundColor: '#10B981' },
  requestHeaderText: { fontSize: 11, color: '#10B981', fontWeight: '600' },
  requestRestaurant: { fontSize: 17, fontWeight: 'bold', color: '#1E293B' },
  requestDistanceRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  requestDistanceText: { fontSize: 12, color: '#64748B' },
  requestDropoff: { fontSize: 12, color: '#64748B', marginTop: 2 },
  requestRight: { alignItems: 'flex-end', gap: 12 },
  timerRow: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#FFF7ED', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  timerText: { fontSize: 11, color: '#FF8C00', fontWeight: '700' },
  requestPrice: { fontSize: 18, fontWeight: 'bold', color: '#10B981' },
  progressBarWrapper: { height: 5, backgroundColor: '#F1F5F9', width: '100%' },
  progressBarActive: { height: '100%', backgroundColor: Colors.primary },
  requestActions: { flexDirection: 'row', padding: 15, gap: 12 },
  declineBtn: {
    flex: 1,
    flexDirection: 'row',
    height: 48,
  ...
  declineText: { color: '#64748B', fontSize: 14, fontWeight: '700' },
  acceptBtn: {
    flex: 1.5,
    flexDirection: 'row',
    height: 48,
  ...
  completedCard: { backgroundColor: '#FFF', borderRadius: 18, padding: 18, borderWidth: 1, borderColor: '#F1F5F9' },
  completedMain: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  completedLeft: { flex: 1, gap: 5 },
  completedName: { fontSize: 15, fontWeight: 'bold', color: '#1E293B' },
  completedAddressRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  completedAddress: { fontSize: 12, color: '#64748B', flexShrink: 1 },
  completedDetails: { fontSize: 11, color: '#94A3B8', marginTop: 2 },
  completedPrice: { fontSize: 14, fontWeight: 'bold', color: '#059669' },
  earningsChartCard: {
    backgroundColor: '#FFF',
    borderRadius: 22,
    padding: 22,
  ...
  chartPeriod: { fontSize: 14, fontWeight: 'bold', color: '#1E293B' },
  chartAmount: { fontSize: 12, color: '#94A3B8', marginTop: 2 },
  percentBadge: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  percentText: { color: '#10B981', fontSize: 11, fontWeight: 'bold' },
  chartContent: { flexDirection: 'row', height: 180 },
  chartYAxis: { justifyContent: 'space-between', paddingBottom: 25, marginRight: 15 },
  yText: { fontSize: 10, color: '#94A3B8', fontWeight: '600' },
  ...
  barBackground: { flex: 1, width: 24, backgroundColor: '#F8FAFC', borderRadius: 6, justifyContent: 'flex-end', overflow: 'hidden' },
  barFill: { width: '100%', backgroundColor: '#F1F5F9', borderRadius: 6 },
  barFillActive: { backgroundColor: Colors.primary },
  barLabel: { fontSize: 11, color: '#94A3B8', fontWeight: '600' },
  barLabelActive: { color: '#1E293B', fontWeight: 'bold' },
});
