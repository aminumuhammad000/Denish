        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[32px] w-full">
          ...
          >
            <img
              src={becomeVendorImg}
              alt="Become a Vendor"
              className="w-full h-full object-cover object-bottom scale-150 origin-bottom lg:scale-110 group-hover:scale-[1.55] md:group-hover:scale-105 transition-transform duration-700"
            />
            {/* Overlay Gradient */}
