...
import HeroImageImg from "../../../../public/images/HeroImage3.png";
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full gap-12 md:gap-[58px]">
          ...
          >
            ...
            <div className="flex flex-row justify-start items-center gap-2 sm:gap-4 mt-2 w-full animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-both">
              ...
              <Link
                href="#how-it-works"
                className="flex-1 bg-[#F8F8F8] border border-[#747475] text-[#212121] text-[13px] sm:text-[18px] font-semibold h-[54px] sm:h-[69px] px-2 sm:px-10 rounded-[12px] flex items-center justify-center hover:bg-white transition-all whitespace-nowrap"
                style={{ fontFamily: "var(--font-inter)" }}
              >
                See How It Works
              </Link>
          ...
          {/* Right Column - Image */}
          <div className="absolute md:relative inset-0 md:inset-auto z-0 md:z-10 md:ml-auto w-[130%] -left-[15%] md:left-auto md:w-full md:max-w-[544px] aspect-4/5 md:aspect-544/632 mx-auto pt-48 md:pt-0 animate-in fade-in zoom-in-95 duration-1000 delay-300 fill-mode-both">
            <div className="relative h-full w-full md:rounded-[12px] md:overflow-hidden mask-hero-fade md:mask-none scale-[1.5] md:scale-100">
              <Image
                src={HeroImageImg}
                alt="Denish Vendor"
                fill
                ...
                sizes="(max-width: 768px) 130vw, 544px"
              />
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 md:px-[100px] py-8 md:py-[50px]">
          <div className="grid grid-cols-2 md:grid-cols-4 justify-center items-start w-full gap-y-10 gap-x-4 max-w-[1240px] mx-auto">
            <div className="flex flex-col items-center text-center space-y-3">
              <p
                className="text-[18px] sm:text-[24px] font-black text-[#212121] tracking-tighter leading-[1.23]"
                style={{
                  fontFamily: "var(--font-plus-jakarta-sans)",
                  fontSize: "var(--fs-h3)",
                }}
              ...
              <p
                className="text-[14px] sm:text-[20px] font-medium text-[#747475] tracking-tight leading-[1.23]"
                style={{
                  fontFamily: "var(--font-plus-jakarta-sans)",
