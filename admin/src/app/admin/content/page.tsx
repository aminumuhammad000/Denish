...
import { Plus, Trash2, Edit2, Layout, Sliders, Tags, Calendar, Camera, X } from "lucide-react";
...
export default function ContentManagementPage() {
  ...
  const initialBanners: BannerCardProps[] = [
    {
      id: "1",
      title: "Free Delivery Weekend",
      description: "Enjoy free delivery on all orders this weekend!",
      dateRange: "2026-04-08 → 2026-04-20",
    ...
    },
    {
      ...
      description: "Check out Spice Avenue - Now on Denish App",
      dateRange: "2026-04-08 → 2026-04-20",
      image: "/images/new_restaurant.png",
      status: "active",
    },
    {
      id: "3",
      title: "Refer and Earn",
      description: "Refer a friend and earn N500 credit",
      dateRange: "2026-04-08 → 2026-04-20",
  ...
  const [banners, setBanners] = useState<BannerCardProps[]>(initialBanners);
  const [editingBannerId, setEditingBannerId] = useState<string | null>(null);
  const [bannerCounter, setBannerCounter] = useState(initialBanners.length + 1);
  ...
  const handleSaveBanner = async () => {
    if (editingBannerId) {
      ...
      const newBanner: BannerCardProps = {
        id: bannerCounter.toString(),
        ...newBannerData as any
      };

      setBanners([newBanner, ...banners]);
      setBannerCounter((prev) => prev + 1);
