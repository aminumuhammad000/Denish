...
export default function RidersLoading() {
  return (
    <div className="w-full min-h-screen bg-[#F8FAF9] pb-20 animate-in fade-in duration-500">
      {/* Hero Section Skeleton */}
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8 xl:px-[100px] pt-[70px] md:pt-[60px]">
        <div className="w-full flex flex-col md:flex-row justify-between items-center gap-12 md:gap-[58px]">
          ...
          <div className="w-full max-w-[638px] flex flex-col gap-6">
            ...
            <div className="flex flex-row gap-4 mt-6">
              <Skeleton className="h-[60px] w-[180px] rounded-[30px]" />
            </div>
          </div>
          
          {/* Right Column */}
          <div className="w-full md:w-[500px] lg:w-[600px] h-[300px] md:h-[500px]">
      ...
      <div className="w-full bg-white mt-20 pt-20 pb-20">
